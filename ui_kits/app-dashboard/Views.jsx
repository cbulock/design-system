      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 12 }}>
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 6 }}>
          ...
          {[
            ...
            { who: 'sam',    color: '#42403a', what: 'commented on cindor review',          when: '4h', tag: 'note' },
...
function ProjectsView() {
  const rows = [
    { name: 'cindor',         owner: 'alex',   status: 'live',     tone: 'success', updated: '2h',  ver: 'v0.3.0', color: '#c2410c' },
...
function InboxView() {
  const items = [
    ...
    { from: 'sam',    color: '#42403a', subj: 'cindor v0.3 — notes',              preview: 'a few small things on the button states. nothing blocking, but worth discussing.', time: '08:02', unread: true },
