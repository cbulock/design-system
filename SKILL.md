...
If creating visual artifacts (slides, mocks, throwaway prototypes, etc.), copy assets out (the CSS file, fonts, icon components) and create static HTML files for the user to view. If working on production code, copy the tokens and read the rules in `README.md` to become an expert in designing with Emberline.
